        ...
        try:
            ...
            if users_list:
                for user in users_list:
                    # CORREÇÃO DO ERRO ANTERIOR: st.columns(3)
                    ...
                    if user['status'] == 'pendente' and c2.button("Aprovar", key=user['email']):
                        # CORREÇÃO DA DATA: Registra a aprovação com fuso horário UTC
...
# --- 6. CONTEÚDO TÉCNICO ---
# Adicione aqui o restante das abas Equipamento/Dimensões, Cálculos e Relatórios
st.info("Acesso autorizado. Utilize as abas abaixo para os cálculos.")
