...
def calcular_correntes_interpoladas(voc, ibf, g):
    # Coeficientes da tabela para VCB
    coef_vcb = {
    ...
    iarc600 = calcular_iarc("600", ibf, g, coef_vcb["600"])
    iarc2700 = calcular_iarc("2700", ibf, g, coef_vcb["2700"])
    iarc14300 = calcular_iarc("14300", ibf, g, coef_vcb["14300"])
...
def calcular_energia_incidente(voc, ibf, g, d, t, cf, iarc600, iarc2700, iarc14300):
    ...
    e600 = energia("600", iarc600, coef_vcb["600"])
    e2700 = energia("2700", iarc2700, coef_vcb["2700"])
    e14300 = energia("14300", iarc14300, coef_vcb["14300"])
...
# Função para calcular distância-limite
def calcular_dla(voc, ibf, g, d, cf, iarc600, iarc2700, iarc14300):
    # Implementação similar às funções acima
    pass
...
# Cálculos
iarc600, iarc2700, iarc14300, iarc_final = calcular_correntes_interpoladas(voc, ibf, g)
e600, e2700, e14300, energia_final = calcular_energia_incidente(voc, ibf, g, d, t, cf, iarc600, iarc2700, iarc14300)
