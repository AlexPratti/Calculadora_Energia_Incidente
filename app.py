...
# --- 1. CONFIGURAÇÃO E CONEXÃO ÚNICA COM SUPABASE ---
...
with tab2:
    ...
    if st.button("Executar Estudo"):
        ...
        with c_tab:
            ...
            st.metric("Energia Incidente (J/cm²)", f"{e_trab_cal*4.184:.2f} J/cm²")
...
with tab3:
    if 'res' in st.session_state:
        ...
        st.download_button("📩 Baixar Relatório Profissional (PDF)", data=pdf_data, file_name=f"Laudo_Arco_{cliente}.pdf", use_container_width=True)
